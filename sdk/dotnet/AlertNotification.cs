...
{
    public partial class AlertNotification : Pulumi.CustomResource
    {
        [Output("isDefault")]
        ...
        public AlertNotification(string name, AlertNotificationArgs args, CustomResourceOptions? options = null)
            : base("grafana:/alertNotification:AlertNotification", name, args ?? new AlertNotificationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AlertNotification(string name, Input<string> id, AlertNotificationState? state = null, CustomResourceOptions? options = null)
            : base("grafana:/alertNotification:AlertNotification", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AlertNotificationArgs : Pulumi.ResourceArgs
    {
        [Input("isDefault")]
    ...
    public sealed class AlertNotificationState : Pulumi.ResourceArgs
    {
        [Input("isDefault")]
        public Input<bool>? IsDefault { get; set; }
