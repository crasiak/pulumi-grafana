...
class AlertNotification(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, is_default=None, name=None, settings=None, type=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        super(AlertNotification, __self__).__init__(
            'grafana:/alertNotification:AlertNotification',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, is_default=None, name=None, settings=None, type=None):
        """
